...
const Sidebar = ({ userPhone, userPassword }) => {
  ...
  const avatarSrc = user && user.avatar
    ...
    : 'https://media.istockphoto.com/id/1485546774/photo/bald-man-smiling-at-camera-standing-with-arms-crossed.webp?a=1&b=1&s=612x612&w=0&k=20&c=0ids4O4zdfqqB3DcwDY9SGuKOEgTTlpW4csklV0v8t0=';

  const userName = user ? user.name : 'Brian Juma';
